...
export const unit202TechnicalSourceVerification: TechnicalSourceVerificationManifest = {
  ...
  // =====================================================================
  // CC-15B: every VERIFIED candidate below now names verifiedSourceLocatorKeys
  // -- the exact locator(s) THAT candidate was actually verified against,
  // never inherited from a sibling candidate sharing the same sourceKey (see
  // this file's SRC_OPENSTAX_UP2 group below, where 20 distinct dossier
  // candidates share one sourceKey but each binds only its own section's
  // locator(s)). Bindings were populated only from already-existing CC-15/
  // CC-15A locators -- no new retrieval, no new source, no re-scoping.
  approvedSources: [
    {
      dossierSourceId: "SRC-BIPM-SI-9E-V4.01", sourceKey: SRC_BIPM, approvedRole: "PRIMARY SI factual authority", status: "VERIFIED",
      verifiedSourceLocatorKeys: ["loc-bipm-base-units", "loc-bipm-kelvin-celsius", "loc-bipm-derived-units", "loc-bipm-derived-units-examples", "loc-bipm-si-prefixes", "loc-bipm-nonsi-units"],
    },
    { dossierSourceId: "SRC-NIST-SP811-CH4", sourceKey: SRC_NIST_SP811, approvedRole: "SECONDARY / practical SI factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-nist-sp811-ch4"] },
    { dossierSourceId: "SRC-NIST-SP811-B9", sourceKey: SRC_NIST_SP811, approvedRole: "SECONDARY electrical/magnetic SI factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-nist-sp811-b9"] },
    { dossierSourceId: "SRC-NIST-SP811-B8", sourceKey: SRC_NIST_SP811, approvedRole: "SECONDARY physical-quantity/conversion authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-nist-sp811-b8"] },
    { dossierSourceId: "SRC-OPENSTAX-PREALG-PERCENT", sourceKey: SRC_OPENSTAX_PREALGEBRA, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-prealg-percent"] },
    { dossierSourceId: "SRC-OPENSTAX-INTERALG-FORMULA", sourceKey: SRC_OPENSTAX_INTERALG, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-interalg-formula"] },
    { dossierSourceId: "SRC-OPENSTAX-PREALG-SCI-NOTATION", sourceKey: SRC_OPENSTAX_PREALGEBRA, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-prealg-sci-notation"] },
    { dossierSourceId: "SRC-OPENSTAX-PREALG-PYTHAGORAS", sourceKey: SRC_OPENSTAX_PREALGEBRA, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-prealg-pythagoras"] },
    { dossierSourceId: "SRC-OPENSTAX-PRECALC-TRIG", sourceKey: SRC_OPENSTAX_PRECALC, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-precalc-trig"] },
    { dossierSourceId: "SRC-OPENSTAX-STATS-CENTER", sourceKey: SRC_OPENSTAX_STATS, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-stats-center"] },
    { dossierSourceId: "SRC-OPENSTAX-UP1-MASS-WEIGHT", sourceKey: SRC_OPENSTAX_UP1, approvedRole: "PRIMARY mechanics factual authority for AC3.1", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up1-mass-weight"] },
    { dossierSourceId: "SRC-OPENSTAX-PHYSICS-WORK-POWER", sourceKey: SRC_OPENSTAX_PHYSICS, approvedRole: "PRIMARY mechanics factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-physics-work-power"] },
    {
      ...
      verifiedSourceLocatorKeys: ["loc-physics-simple-machines", "loc-physics-simple-machines-pulleys"],
    },
    { dossierSourceId: "SRC-LIBRETEXTS-LEVER-CLASSES", sourceKey: SRC_LIBRETEXTS_LEVER, approvedRole: "factual authority for lever classification/operation", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-libretexts-lever"] },
    { dossierSourceId: "SRC-LIBRETEXTS-GEAR-SYSTEMS", sourceKey: SRC_LIBRETEXTS_GEAR_SYSTEMS, approvedRole: "factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-libretexts-gear-systems"] },
    { dossierSourceId: "SRC-LIBRETEXTS-GEAR-POWER-TORQUE", sourceKey: SRC_LIBRETEXTS_MECHATRONICS, approvedRole: "secondary factual authority for ideal gearbox torque/speed/power relationships", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-libretexts-mechatronics"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-ELECTRIC-CHARGE", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-electric-charge"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-ELECTRICAL-CURRENT", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY electrical-current factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-electrical-current"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-CONDUCTORS-INSULATORS", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY conductor/insulator factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-conductors-insulators"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-RESISTIVITY", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY resistance/resistivity authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-resistivity"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-OHM", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-ohm"] },
    {
      ...
      verifiedSourceLocatorKeys: ["loc-up2-electrical-power", "loc-up2-electrical-power-fuse"],
    },
    { dossierSourceId: "SRC-OPENSTAX-UP2-SERIES-PARALLEL", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY DC circuit factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-series-parallel"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-KIRCHHOFF", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "secondary factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-kirchhoff"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-MEASURING-INSTRUMENTS", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-measuring-instruments"] },
    {
    ...
    { dossierSourceId: "SRC-SCHNEIDER-ION7400-ENERGY", sourceKey: SRC_SCHNEIDER_ION7400, approvedRole: "manufacturer application authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-schneider-ion7400-energy"] },
    { dossierSourceId: "SRC-OPENSTAX-CHEM-ELECTROLYSIS", sourceKey: SRC_OPENSTAX_CHEMISTRY, approvedRole: "PRIMARY chemistry factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-chem-electrolysis"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-SIMPLE-AC", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY AC quantity factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-simple-ac"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-RLC-IMPEDANCE", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "factual authority, tightly clipped", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-rlc-impedance"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-AC-POWER", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "factual authority, tightly clipped", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-ac-power"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-MAGNETIC-FIELDS", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY magnetism factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-magnetic-fields"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-CURRENT-CONDUCTOR-FORCE", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY motor-effect factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-current-conductor-force"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-STRAIGHT-WIRE", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "factual/directional authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-straight-wire"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-SOLENOID", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "factual/directional authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-solenoid"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-FARADAY-FLUX", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY magnetic-flux/induction authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-faraday-flux"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-MOTIONAL-EMF", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY induced-EMF factual/procedural authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-motional-emf"] },
    {
      // Bound honestly to the two locators this candidate was actually
      // retrieved/inspected against, even though their content proved
      // insufficient for the Fleming's-rule propositions (both remain
      // SOURCE_GAP) -- this field records source-retrieval integrity, not
      // proposition sufficiency; see the schema module header.
      ...
      verifiedSourceLocatorKeys: ["loc-nagoya-fleming-left", "loc-nagoya-fleming-right"],
    },
    {
      ...
      verifiedSourceLocatorKeys: ["loc-up2-generators", "loc-up2-generators-period-frequency"],
    },
    { dossierSourceId: "SRC-ECAMPUS-SIMPLE-AC-GENERATOR", sourceKey: SRC_ECAMPUS_ELECTROTECHNOLOGY, approvedRole: "secondary electrotechnology factual/pedagogical authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-ecampus-simple-ac-generator"] },
    { dossierSourceId: "SRC-ECAMPUS-ALTERNATOR-RELATIONSHIPS", sourceKey: SRC_ECAMPUS_ELECTROTECHNOLOGY, approvedRole: "PRIMARY Unit-202-level alternator frequency relationship authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-ecampus-alternator-relationships"] },
    { dossierSourceId: "SRC-ABB-POLE-PAIR-CONVENTION", sourceKey: SRC_ABB_ASYNC_MOTORS, approvedRole: "independent manufacturer cross-check for pole-pair convention", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-abb-pole-pair-annex-a"] },
    {
      ...
      verifiedSourceLocatorKeys: ["loc-iastate-waveform-magnitude", "loc-iastate-rms"],
    },
    { dossierSourceId: "SRC-OPENSTAX-UP2-CAPACITORS", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "PRIMARY capacitor factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-capacitors"] },
    { dossierSourceId: "SRC-OPENSTAX-UP2-CAPACITOR-ENERGY", sourceKey: SRC_OPENSTAX_UP2, approvedRole: "secondary capacitor authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-up2-capacitor-energy"] },
    { dossierSourceId: "SRC-TE-RESISTOR-COLOR", sourceKey: SRC_TE_RESISTOR_COLOR, approvedRole: "manufacturer/component factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-te-resistor-4band"] },
    { dossierSourceId: "SRC-ROHM-DIODE-BASICS", sourceKey: SRC_ROHM_DIODE_BASICS, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-diode-basics"] },
    { dossierSourceId: "SRC-ROHM-RECTIFIER-DIODE", sourceKey: SRC_ROHM_RECTIFIER, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-rectifier"] },
    { dossierSourceId: "SRC-ROHM-ZENER", sourceKey: SRC_ROHM_ZENER, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-zener"] },
    { dossierSourceId: "SRC-ROHM-LED-FORWARD", sourceKey: SRC_ROHM_LED_FORWARD, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-led-forward"] },
    { dossierSourceId: "SRC-ROHM-LED-EMISSION", sourceKey: SRC_ROHM_LED_EMISSION, approvedRole: "manufacturer factual authority, narrowly clipped", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-led-emission"] },
    { dossierSourceId: "SRC-HAMAMATSU-PHOTODIODE", sourceKey: SRC_HAMAMATSU_PHOTODIODE, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-hamamatsu-photodiode"] },
    { dossierSourceId: "SRC-ADVPHOTONIX-LDR", sourceKey: SRC_ADVPHOTONIX_LDR, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-advphotonix-ldr"] },
    { dossierSourceId: "SRC-MURATA-NTC", sourceKey: SRC_MURATA_NTC, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-murata-ntc"] },
    { dossierSourceId: "SRC-MURATA-PTC", sourceKey: SRC_MURATA_PTC, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-murata-ptc"] },
    { dossierSourceId: "SRC-ST-DIAC-DB3", sourceKey: SRC_ST_DIAC_DB3, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-st-diac-db3"] },
    {
    ...
    { dossierSourceId: "SRC-ROHM-BJT", sourceKey: SRC_ROHM_BJT, approvedRole: "manufacturer factual authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-bjt"] },
    { dossierSourceId: "SRC-ROHM-NPN-SWITCH", sourceKey: SRC_ROHM_NPN_SWITCH, approvedRole: "manufacturer application authority", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-rohm-npn-switch"] },
    {
      ...
      verifiedSourceLocatorKeys: ["loc-st-an4607-1.1", "loc-st-an4607-1.2"],
    },
    { dossierSourceId: "SRC-OMRON-E5C2-TEMP-CONTROLLER", sourceKey: SRC_OMRON_E5C2, approvedRole: "bounded manufacturer application evidence", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-omron-e5c2-specs"] },
    { dossierSourceId: "SRC-ABB-DRIVE-SYSTEM", sourceKey: SRC_ABB_DRIVES_TECH_GUIDE7, approvedRole: "PRIMARY manufacturer application authority for basic AC-drive block structure", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-abb-drives-fig1.1"] },
    { dossierSourceId: "SRC-TI-WIRELESS-ENV-SENSOR", sourceKey: SRC_TI_WIRELESS_ENV_SENSOR, approvedRole: "bounded manufacturer application evidence", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-ti-wireless-env-sensor"] },
    { dossierSourceId: "SRC-TI-TIDA-01067", sourceKey: SRC_TI_TIDA_01067, approvedRole: "bounded manufacturer application evidence", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-ti-tida-01067"] },
    { dossierSourceId: "SRC-OPENREACH-DIGITAL-PHONE", sourceKey: SRC_OPENREACH_DIGITAL_PHONE, approvedRole: "PRIMARY current-industry authority for UK network-transition context", status: "VERIFIED", verifiedSourceLocatorKeys: ["loc-openreach-digital-phone"] },
    {

...
import {
  LESSON_SIMPLE_MACHINES_V4_V6_HISTORICAL,
  LESSON_RESISTIVITY_V3_V6_HISTORICAL,
  LESSON_ELECTRONIC_COMPONENTS_PASSIVE_V4_V6_HISTORICAL,
  LESSON_ELECTRONIC_COMPONENTS_SWITCHING_CONTROL_V4_V6_HISTORICAL,
  LESSON_MAGNETISM_FUNDAMENTALS_V5_V6_HISTORICAL,
  LESSON_MAGNETIC_EFFECTS_OF_CURRENT_V5_V6_HISTORICAL,
  LESSON_AC_GENERATION_PRINCIPLES_V5_V6_HISTORICAL,
} from "./lesson-cc11-3-historical-snapshot.ts";
import {
  LESSON_MAGNETISM_FUNDAMENTALS_V7_HISTORICAL,
  LESSON_MAGNETIC_EFFECTS_OF_CURRENT_V7_HISTORICAL,
} from "./lesson-cc12-v7-historical-snapshot.ts";
import {
  RELEASE_UNIT202_V2,
  RELEASE_UNIT202_V3,
  RELEASE_UNIT202_V4,
...
// CC-11.3: sourced from the frozen pre-CC-11.3 snapshot, not the live
// (now release.unit202.v7-tagged) lesson object -- see that snapshot
// file's own header comment.
export const LESSON_RESISTIVITY_UNIT202_V4: LessonPlan = { ...LESSON_RESISTIVITY_V3_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V4 };
...
// CC-11.3: sourced from frozen pre-CC-11.3 snapshots -- see the same
// note on the v4 override above.
export const LESSON_RESISTIVITY_UNIT202_V5: LessonPlan = { ...LESSON_RESISTIVITY_V3_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V5 };
...
export const LESSON_SIMPLE_MACHINES_UNIT202_V5: LessonPlan = { ...LESSON_SIMPLE_MACHINES_V4_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V5 };
...
export const LESSON_ELECTRONIC_COMPONENTS_PASSIVE_UNIT202_V5: LessonPlan = {
  ...LESSON_ELECTRONIC_COMPONENTS_PASSIVE_V4_V6_HISTORICAL,
  contentRelease: RELEASE_UNIT202_V5,
};
...
// CC-11.3: sourced from frozen pre-CC-11.3 snapshots -- these three
// lessons were previously referenced directly (bare) in v5's own
// membership block, since v5 was their native contentRelease; now that
// their native tag reads v7, v5 needs its own explicit override const,
// exactly like every other release-scoped reuse in this file.
export const LESSON_MAGNETISM_FUNDAMENTALS_UNIT202_V5: LessonPlan = { ...LESSON_MAGNETISM_FUNDAMENTALS_V5_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V5 };
export const LESSON_MAGNETIC_EFFECTS_OF_CURRENT_UNIT202_V5: LessonPlan = {
  ...LESSON_MAGNETIC_EFFECTS_OF_CURRENT_V5_V6_HISTORICAL,
  contentRelease: RELEASE_UNIT202_V5,
};
export const LESSON_AC_GENERATION_PRINCIPLES_UNIT202_V5: LessonPlan = { ...LESSON_AC_GENERATION_PRINCIPLES_V5_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V5 };
...
// CC-11.3: sourced from frozen pre-CC-11.3 snapshots -- see the same
// note on the v4 override above.
export const LESSON_RESISTIVITY_UNIT202_V6: LessonPlan = { ...LESSON_RESISTIVITY_V3_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V6 };
...
export const LESSON_SIMPLE_MACHINES_UNIT202_V6: LessonPlan = { ...LESSON_SIMPLE_MACHINES_V4_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V6 };
export const LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER_UNIT202_V6: LessonPlan = {
  ...LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER,
  contentRelease: RELEASE_UNIT202_V6,
};
export const LESSON_MAGNETISM_FUNDAMENTALS_UNIT202_V6: LessonPlan = { ...LESSON_MAGNETISM_FUNDAMENTALS_V5_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V6 };
export const LESSON_MAGNETIC_EFFECTS_OF_CURRENT_UNIT202_V6: LessonPlan = {
  ...LESSON_MAGNETIC_EFFECTS_OF_CURRENT_V5_V6_HISTORICAL,
  contentRelease: RELEASE_UNIT202_V6,
};
export const LESSON_AC_GENERATION_PRINCIPLES_UNIT202_V6: LessonPlan = { ...LESSON_AC_GENERATION_PRINCIPLES_V5_V6_HISTORICAL, contentRelease: RELEASE_UNIT202_V6 };
...
export const LESSON_ELECTRONIC_COMPONENTS_PASSIVE_UNIT202_V6: LessonPlan = {
  ...LESSON_ELECTRONIC_COMPONENTS_PASSIVE_V4_V6_HISTORICAL,
  contentRelease: RELEASE_UNIT202_V6,
};
...
/**
 * CC-11.3: `release.unit202.v7` carries the same 24-lesson membership as
 * v6 (see content-releases.ts's own RELEASE_UNIT202_V7 doc comment for
 * why v6 itself could not simply be grown in place). 17 of these 24
 * lessons' step content is genuinely unchanged from v6 -- re-addressed
 * here via the same plain-field-override pattern as every release
 * before it. The remaining 7
 * (LESSON_SIMPLE_MACHINES/LESSON_RESISTIVITY/LESSON_MAGNETISM_
 * FUNDAMENTALS/LESSON_MAGNETIC_EFFECTS_OF_CURRENT/LESSON_AC_GENERATION_
 * PRINCIPLES/LESSON_ELECTRONIC_COMPONENTS_PASSIVE/LESSON_ELECTRONIC_
 * COMPONENTS_SWITCHING_CONTROL) are referenced directly, unwrapped,
 * below -- their own native `contentRelease` field now reads v7 (their
 * step content gained REQUIRED instructional-visual integration, so v7
 * is their first, and only, true release identity for this content; see
 * each lesson's own CC-11.3 header comment for exactly what changed).
 */
export const LESSON_OHMS_LAW_UNIT202_V7: LessonPlan = { ...LESSON_OHMS_LAW, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_FOUNDATION_FORMULA_REARRANGEMENT_UNIT202_V7: LessonPlan = {
  ...LESSON_FOUNDATION_FORMULA_REARRANGEMENT,
  contentRelease: RELEASE_UNIT202_V7,
};
export const LESSON_RESISTORS_SERIES_UNIT202_V7: LessonPlan = { ...LESSON_RESISTORS_SERIES, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_RESISTORS_PARALLEL_UNIT202_V7: LessonPlan = { ...LESSON_RESISTORS_PARALLEL, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_CORE_QUANTITIES_UNIT202_V7: LessonPlan = { ...LESSON_CORE_QUANTITIES, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_SI_UNITS_UNIT202_V7: LessonPlan = { ...LESSON_SI_UNITS, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_INSTRUMENTATION_UNIT202_V7: LessonPlan = { ...LESSON_INSTRUMENTATION, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_CHARGE_AND_CURRENT_UNIT202_V7: LessonPlan = { ...LESSON_CHARGE_AND_CURRENT, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_CONDUCTORS_AND_INSULATORS_UNIT202_V7: LessonPlan = { ...LESSON_CONDUCTORS_AND_INSULATORS, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_THERMAL_AND_CHEMICAL_EFFECTS_UNIT202_V7: LessonPlan = { ...LESSON_THERMAL_AND_CHEMICAL_EFFECTS, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_ELECTRICAL_POWER_UNIT202_V7: LessonPlan = { ...LESSON_ELECTRICAL_POWER, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_ELECTRICAL_ENERGY_EFFICIENCY_UNIT202_V7: LessonPlan = { ...LESSON_ELECTRICAL_ENERGY_EFFICIENCY, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_FAULT_CONDITIONS_PROTECTION_UNIT202_V7: LessonPlan = { ...LESSON_FAULT_CONDITIONS_PROTECTION, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_SERIES_VS_PARALLEL_COMPARISON_UNIT202_V7: LessonPlan = { ...LESSON_SERIES_VS_PARALLEL_COMPARISON, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_MASS_AND_WEIGHT_UNIT202_V7: LessonPlan = { ...LESSON_MASS_AND_WEIGHT, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER_UNIT202_V7: LessonPlan = {
  ...LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER,
  contentRelease: RELEASE_UNIT202_V7,
};
export const LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES_UNIT202_V7: LessonPlan = { ...LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES, contentRelease: RELEASE_UNIT202_V7 };
// CC-12: sourced from the frozen pre-CC-12 snapshot, not the live (now
// release.unit202.v8-tagged) lesson object -- these two lessons were
// natively authored for v7, so v7's own membership must keep resolving
// their pre-CC-12 content, exactly the same pattern CC-11.3 established
// above for the lessons IT corrected.
export const LESSON_MAGNETISM_FUNDAMENTALS_UNIT202_V7: LessonPlan = { ...LESSON_MAGNETISM_FUNDAMENTALS_V7_HISTORICAL, contentRelease: RELEASE_UNIT202_V7 };
export const LESSON_MAGNETIC_EFFECTS_OF_CURRENT_UNIT202_V7: LessonPlan = {
  ...LESSON_MAGNETIC_EFFECTS_OF_CURRENT_V7_HISTORICAL,
  contentRelease: RELEASE_UNIT202_V7,
};

/**
 * CC-12: `release.unit202.v8` carries the same 24-lesson membership as
 * v7 (see content-releases.ts's own RELEASE_UNIT202_V8 doc comment for
 * why v7 itself could not simply be grown in place). 22 of these 24
 * lessons' step content is genuinely unchanged from v7 -- re-addressed
 * here via the same plain-field-override pattern as every release
 * before it. The remaining 2 (LESSON_MAGNETISM_FUNDAMENTALS/
 * LESSON_MAGNETIC_EFFECTS_OF_CURRENT) are referenced directly, unwrapped,
 * below -- their own native `contentRelease` field now reads v8 (their
 * step content gained the CC-12 root-cause diagnostic chain / layered-
 * feedback / remediation-eligibility additions, so v8 is their first,
 * and only, true release identity for this content; see each lesson's
 * own CC-12 header comment for exactly what changed).
 */
export const LESSON_OHMS_LAW_UNIT202_V8: LessonPlan = { ...LESSON_OHMS_LAW, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_FOUNDATION_FORMULA_REARRANGEMENT_UNIT202_V8: LessonPlan = {
  ...LESSON_FOUNDATION_FORMULA_REARRANGEMENT,
  contentRelease: RELEASE_UNIT202_V8,
};
export const LESSON_RESISTORS_SERIES_UNIT202_V8: LessonPlan = { ...LESSON_RESISTORS_SERIES, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_RESISTORS_PARALLEL_UNIT202_V8: LessonPlan = { ...LESSON_RESISTORS_PARALLEL, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_CORE_QUANTITIES_UNIT202_V8: LessonPlan = { ...LESSON_CORE_QUANTITIES, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_SI_UNITS_UNIT202_V8: LessonPlan = { ...LESSON_SI_UNITS, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_INSTRUMENTATION_UNIT202_V8: LessonPlan = { ...LESSON_INSTRUMENTATION, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_CHARGE_AND_CURRENT_UNIT202_V8: LessonPlan = { ...LESSON_CHARGE_AND_CURRENT, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_CONDUCTORS_AND_INSULATORS_UNIT202_V8: LessonPlan = { ...LESSON_CONDUCTORS_AND_INSULATORS, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_THERMAL_AND_CHEMICAL_EFFECTS_UNIT202_V8: LessonPlan = { ...LESSON_THERMAL_AND_CHEMICAL_EFFECTS, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_RESISTIVITY_UNIT202_V8: LessonPlan = { ...LESSON_RESISTIVITY, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_ELECTRICAL_POWER_UNIT202_V8: LessonPlan = { ...LESSON_ELECTRICAL_POWER, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_ELECTRICAL_ENERGY_EFFICIENCY_UNIT202_V8: LessonPlan = { ...LESSON_ELECTRICAL_ENERGY_EFFICIENCY, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_FAULT_CONDITIONS_PROTECTION_UNIT202_V8: LessonPlan = { ...LESSON_FAULT_CONDITIONS_PROTECTION, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_SERIES_VS_PARALLEL_COMPARISON_UNIT202_V8: LessonPlan = { ...LESSON_SERIES_VS_PARALLEL_COMPARISON, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_MASS_AND_WEIGHT_UNIT202_V8: LessonPlan = { ...LESSON_MASS_AND_WEIGHT, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_SIMPLE_MACHINES_UNIT202_V8: LessonPlan = { ...LESSON_SIMPLE_MACHINES, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER_UNIT202_V8: LessonPlan = {
  ...LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER,
  contentRelease: RELEASE_UNIT202_V8,
};
export const LESSON_AC_GENERATION_PRINCIPLES_UNIT202_V8: LessonPlan = { ...LESSON_AC_GENERATION_PRINCIPLES, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES_UNIT202_V8: LessonPlan = { ...LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_ELECTRONIC_COMPONENTS_PASSIVE_UNIT202_V8: LessonPlan = { ...LESSON_ELECTRONIC_COMPONENTS_PASSIVE, contentRelease: RELEASE_UNIT202_V8 };
export const LESSON_ELECTRONIC_COMPONENTS_SWITCHING_CONTROL_UNIT202_V8: LessonPlan = {
...
export const lessons: LessonPlan[] = [
  ...
  // CC-11.3: sourced from the frozen pre-CC-11.3 snapshot, not the live
  // (now release.unit202.v7-tagged) lesson object -- this lesson was
  // natively authored for v3, so the snapshot's own native contentRelease
  // (also v3) resolves it directly, bare, exactly as before.
  LESSON_RESISTIVITY_V3_V6_HISTORICAL,
  ...
  // release.unit202.v5 members, re-addressed below; the CC-11.1/CC-11.3-
  // corrected lessons' CURRENT native contentRelease now reads v5/v7, so
  // frozen historical snapshots of their original v4 content stand in
  // here instead -- see lesson-lo5-v4-historical-snapshot.ts,
  // lesson-cc11-3-historical-snapshot.ts and content-releases.ts's
  // RELEASE_UNIT202_V5/V7 doc comments):
  ...
  LESSON_MAGNETISM_FUNDAMENTALS_UNIT202_V5,
  LESSON_MAGNETIC_EFFECTS_OF_CURRENT_UNIT202_V5,
  LESSON_AC_GENERATION_PRINCIPLES_UNIT202_V5,
  ...
  // CC-11.3: release.unit202.v7 -- 17 lessons re-addressed unchanged,
  // plus the 7 CC-11.3-corrected lessons referenced directly (their own
  // native contentRelease already reads v7, REQUIRED instructional-
  // visual integration -- plus, for lesson.emf.ac-generation-principles,
  // a genuine defect fix).
  LESSON_OHMS_LAW_UNIT202_V7,
  LESSON_FOUNDATION_FORMULA_REARRANGEMENT_UNIT202_V7,
  LESSON_RESISTORS_SERIES_UNIT202_V7,
  LESSON_RESISTORS_PARALLEL_UNIT202_V7,
  LESSON_CORE_QUANTITIES_UNIT202_V7,
  LESSON_SI_UNITS_UNIT202_V7,
  LESSON_INSTRUMENTATION_UNIT202_V7,
  LESSON_CHARGE_AND_CURRENT_UNIT202_V7,
  LESSON_CONDUCTORS_AND_INSULATORS_UNIT202_V7,
  LESSON_THERMAL_AND_CHEMICAL_EFFECTS_UNIT202_V7,
  LESSON_RESISTIVITY,
  LESSON_ELECTRICAL_POWER_UNIT202_V7,
  LESSON_ELECTRICAL_ENERGY_EFFICIENCY_UNIT202_V7,
  LESSON_FAULT_CONDITIONS_PROTECTION_UNIT202_V7,
  LESSON_SERIES_VS_PARALLEL_COMPARISON_UNIT202_V7,
  LESSON_MASS_AND_WEIGHT_UNIT202_V7,
  LESSON_SIMPLE_MACHINES,
  LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER_UNIT202_V7,
  LESSON_MAGNETISM_FUNDAMENTALS_UNIT202_V7,
  LESSON_MAGNETIC_EFFECTS_OF_CURRENT_UNIT202_V7,
  LESSON_AC_GENERATION_PRINCIPLES,
  LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES_UNIT202_V7,
  LESSON_ELECTRONIC_COMPONENTS_PASSIVE,
  LESSON_ELECTRONIC_COMPONENTS_SWITCHING_CONTROL,
  // CC-12: release.unit202.v8 -- 22 lessons re-addressed unchanged, plus
  // the 2 CC-12-corrected lessons referenced directly (their own native
  // contentRelease already reads v8, the magnetism vertical-slice
  // correction).
  LESSON_OHMS_LAW_UNIT202_V8,
  LESSON_FOUNDATION_FORMULA_REARRANGEMENT_UNIT202_V8,
  LESSON_RESISTORS_SERIES_UNIT202_V8,
  LESSON_RESISTORS_PARALLEL_UNIT202_V8,
  LESSON_CORE_QUANTITIES_UNIT202_V8,
  LESSON_SI_UNITS_UNIT202_V8,
  LESSON_INSTRUMENTATION_UNIT202_V8,
  LESSON_CHARGE_AND_CURRENT_UNIT202_V8,
  LESSON_CONDUCTORS_AND_INSULATORS_UNIT202_V8,
  LESSON_THERMAL_AND_CHEMICAL_EFFECTS_UNIT202_V8,
  LESSON_RESISTIVITY_UNIT202_V8,
  LESSON_ELECTRICAL_POWER_UNIT202_V8,
  LESSON_ELECTRICAL_ENERGY_EFFICIENCY_UNIT202_V8,
  LESSON_FAULT_CONDITIONS_PROTECTION_UNIT202_V8,
  LESSON_SERIES_VS_PARALLEL_COMPARISON_UNIT202_V8,
  LESSON_MASS_AND_WEIGHT_UNIT202_V8,
  LESSON_SIMPLE_MACHINES_UNIT202_V8,
  LESSON_MECHANICS_FORCE_WORK_ENERGY_POWER_UNIT202_V8,
  LESSON_MAGNETISM_FUNDAMENTALS,
  LESSON_MAGNETIC_EFFECTS_OF_CURRENT,
  LESSON_AC_GENERATION_PRINCIPLES_UNIT202_V8,
  LESSON_AC_DC_AND_SINE_WAVE_QUANTITIES_UNIT202_V8,
  LESSON_ELECTRONIC_COMPONENTS_PASSIVE_UNIT202_V8,
  LESSON_ELECTRONIC_COMPONENTS_SWITCHING_CONTROL_UNIT202_V8,
];

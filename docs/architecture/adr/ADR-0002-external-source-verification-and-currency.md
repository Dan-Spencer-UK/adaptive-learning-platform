...
- The first time an external source is detected as changed (new edition, changed bytes, withdrawal) — confirms or revises the change-impact-analysis model in practice.

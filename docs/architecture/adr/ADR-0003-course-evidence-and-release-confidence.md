...
- The first time the Unit 202 Official Public Assessment Calibration package (the deferred next package) actually populates `OFFICIAL_ASSESSMENT`/`OFFICIAL_ASSESSMENT_EVIDENCE` — confirms the reserved seam works as designed in practice.

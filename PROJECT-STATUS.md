...
**Next package**: deterministic learner-specific lesson assembly/runtime (turning a canonical plan + learner evidence into an actual learner instance) — not started.

...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    notes:
      "Ingested a Product Owner external reference-research handover (53/53 assets matched), corrected the style default to white/near-white, corrected required-labels-are-part-of-acceptance, completed reference acquisition/preparation for all 42 generative assets (Hard Reference Gate: 42/42 READY, PASS), and re-ran the four-asset pilot after correcting a magnet.field audit misread (independently re-verified, not just accepted on authority) plus a phantom-line cleanup pass: 4/4 PASS. Per the pilot's own gate rule, this triggered automatic full Unit 202 production: 42/42 generative assets attempted, 41 PASS / 1 HUMAN_REVIEW_REQUIRED (levers.class-2 -- duplicate FULCRUM label), 51 total Gemini calls. Status is FULL PRODUCTION GENERATED -- AWAITING PRODUCT OWNER / CHATGPT VISUAL REVIEW; nothing has entered the shipped asset tree or the approved-artwork manifest.",
    gate: "Product Owner / ChatGPT visual review of reports/instructional-visuals/unit202-visual-production-review.pdf is the outstanding gate before this stage is COMPLETE. unit202.levers.class-2 also needs human resolution of its duplicate-label defect.",
  },
  { id: "cc-12", label: "CC-12 -- Electrical Power Slice", kind: "STAGE", status: "NOT_STARTED", dependsOn: ["cc-11.9"], notes: "Explicitly not started -- next course after Unit 202. Blocked on: Product Owner / ChatGPT visual review of the completed Unit 202 production run." },

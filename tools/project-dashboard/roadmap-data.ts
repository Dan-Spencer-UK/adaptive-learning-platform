...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    notes:
      "External review of the CC-11.9 package identified specific defects; this package fixed them without re-opening architecture/reference-research. Generated all 12 missing canonicalState learner-visible outputs for the 3 direction-sensitive assets (current-conductor.magnetic-field, motor.effect.horizontal-poles, motor.effect.vertical-poles -- previously only a direction-neutral base existed), each direction independently re-derived from first-principles physics and pixel-verified. Corrected magnet.permanent-vs-electromagnet (added an unmistakable battery symbol) and electrolysis (removed a regressed voltmeter/ammeter, added correct ion movement). Applied a low-risk cleanup to magnet.poles.unlike. Fixed a real review-package bug (stale primaryReference display instead of the handover-corrected effective reference) and extended the review package to show one page per canonicalState output. unit202.levers.class-2's duplicate FULCRUM label remains HUMAN_REVIEW_REQUIRED after two further correction attempts this package (bounded-retry discipline applied, not retried further). Net tally: 51 attempted, 50 PASS, 1 HUMAN_REVIEW_REQUIRED, 66 total Gemini calls.",
    gate: "Product Owner / ChatGPT visual review of the regenerated reports/instructional-visuals/unit202-visual-production-review.pdf is the outstanding gate before this stage is COMPLETE. unit202.levers.class-2 needs a deterministic-overlay label fix or further human resolution.",
  },
  { id: "cc-12", label: "CC-12 -- Electrical Power Slice", kind: "STAGE", status: "NOT_STARTED", dependsOn: ["cc-11.10"], notes: "Explicitly not started -- next course after Unit 202. Blocked on: Product Owner / ChatGPT visual review of the completed Unit 202 production run." },

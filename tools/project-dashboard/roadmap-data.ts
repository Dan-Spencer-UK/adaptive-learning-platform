...
export const ROADMAP: RoadmapItem[] = [
  ...
  {
    id: "cc-11.9",
    label: "CC-11.9 -- External Reference Handover Implementation, White/Light Style Correction & Four-Asset Pilot",
    kind: "STAGE",
    status: "IN_PROGRESS",
    dependsOn: ["cc-11.8"],
    isCurrentPosition: true,
    notes:
      "Ingested a Product Owner external reference-research handover (53/53 assets matched), corrected the style default to white/near-white, corrected required-labels-are-part-of-acceptance, reclassified the prior magnet.field PASS as REJECTED, and ran the required four-asset pilot: 2 PASS (levers.class-1, generator.rotating-loop.horizontal), 1 HUMAN_REVIEW_REQUIRED (magnet.field -- a real residual arrow-direction defect after its retry budget), 1 not attempted (resistor -- blocked on an external Wikimedia rate limit). Per the pilot's own explicit gate rule, this is a NO-GO: full Unit 202 production was correctly not started.",
    gate: "Four-asset pilot must achieve 4/4 PASS before full Unit 202 production may begin automatically. Currently 2/4 PASS -- BLOCKED. See reports/instructional-visuals/unit202-four-asset-pilot-review.pdf.",
  },
  { id: "cc-12", label: "CC-12 -- Electrical Power Slice", kind: "STAGE", status: "NOT_STARTED", dependsOn: ["cc-11.9"], notes: "Explicitly not started -- next course after Unit 202. Blocked on: the CC-11.9 pilot re-run reaching 4/4 PASS, then the full REQUIRED/USEFUL art-job production run." },

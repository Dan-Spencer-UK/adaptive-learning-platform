...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    gate: "THREE-ASSET BOUNDED CORRECTNESS PACKAGE COMPLETE -- AWAITING PRODUCT OWNER / CHATGPT REVIEW. CC-12 not started.",
  },
  { id: "cc-12", label: "CC-12 -- Electrical Power Slice", kind: "STAGE", status: "NOT_STARTED", dependsOn: ["cc-11.14"], notes: "Explicitly not started -- next course after Unit 202. Blocked on Product Owner / ChatGPT final review of the Unit 202 visual package (three-asset correctness proof plus the suite-wide polish pass and remaining deferred component-family work)." },

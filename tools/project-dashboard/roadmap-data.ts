...
export const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    gate: "Zero image-generation calls. The 3-asset bounded correctness package (right-hand-grip.teaching, emf.motional, levers.class-3) is recorded and ready but not started this package.",
  },
  { id: "cc-12", label: "CC-12 -- Electrical Power Slice", kind: "STAGE", status: "NOT_STARTED", dependsOn: ["cc-11.13a"], notes: "Explicitly not started -- next course after Unit 202. Blocked on: the recommended bounded right-hand-grip/emf.motional/Class-III-lever fix package, then Product Owner / ChatGPT final review of the Unit 202 visual package." },

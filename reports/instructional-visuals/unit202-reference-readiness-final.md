...
| assetId | status | research decision | source |
|---|---|---|---|
| `unit202.current-conductor.magnetic-field` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Wire_fieldlines.svg |
| `unit202.right-hand-grip.teaching` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Right-hand_grip_rule.svg |
| `unit202.motor.effect.horizontal-poles` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:VFPt_wire-in-homogenous-magnetic-field-with-magnets-and-lorentz-force.svg |
| `unit202.motor.effect.vertical-poles` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:VFPt_wire-in-homogenous-magnetic-field-with-magnets-and-lorentz-force.svg |
| `unit202.fleming-left-hand.teaching` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Fleming%27s_Left_Hand_Rule.png |
...
| `unit202.magnet.poles.like` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:VFPt_cylindrical_magnets_repelling.svg |
| `unit202.magnet.poles.unlike` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:VFPt_cylindrical_magnets_attracting.svg |
| `unit202.magnet.permanent-vs-electromagnet` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:VFPt_cylindrical_tightly-wound_coil-and-bar-magnet-comparison.svg |
| `unit202.instrument.clamp-meter` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Clampmeter.jpg |
| `unit202.instrument.oscilloscope` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Oscilloscope_Clean.svg |
| `unit202.gears.driven-larger` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:Two_spur_gears_1_2.svg |
| `unit202.gears.driven-smaller` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:Two_spur_gears_1_2.svg |
...
| `unit202.components.physical.led` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:LED,_5mm,_clear_(unlabelled,_full).svg |
| `unit202.components.physical.thermistor` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:NTC_Thermistor.jpg |
| `unit202.components.physical.transistor` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:TO-92,_BC548_(front,_shaded).svg |
| `unit202.diode.bias-direction.forward` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:Forward-Biased_pn_Junction.svg |
| `unit202.diode.bias-direction.reverse` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:Reverse-Biased_pn_Junction_Bands.svg |
| `unit202.components.physical.zener-diode` | READY | APPROVED_PRODUCTION_REFERENCE | https://commons.wikimedia.org/wiki/File:1N829_Zener_Diode.jpg |
...
| `unit202.protective-devices` | READY | APPROVED_WITH_PREPARATION | https://commons.wikimedia.org/wiki/File:10A_ceramic_6x32_fuse.JPG |

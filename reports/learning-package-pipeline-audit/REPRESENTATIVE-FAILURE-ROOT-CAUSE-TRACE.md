...
- **LEARNER-VISIBLE RESULT**: recap screen → a second screen also labelled "Lesson complete" with near-identical text → a third screen (`LessonCompletionView`) with the exact same text again — three consecutive Continue-gated "you're done" screens, for 23 of 24 real lessons.
